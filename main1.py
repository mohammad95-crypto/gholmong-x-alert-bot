...
async def send_telegram_alert(post):
    ...
    try:
        ...
        print(f"✅ Alert sent to owner for @{post['username']}")
...
def run_bot():
    ...
    telegram_app.add_handler(CommandHandler("add", add_account))
    telegram_app.add_handler(CommandHandler("list", list_accounts))
    ...
    telegram_loop.run_until_complete(telegram_app.updater.start_polling())
